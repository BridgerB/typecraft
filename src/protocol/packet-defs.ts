...
export const PACKET_DEFS: Readonly<Record<string, unknown>> = {
	...
	"play.toClient.packet_waypoint": ["container",[{"name":"entityId","type":"varint"},{"name":"operation","type":["mapper",{"type":"varint","mappings":{"0":"track","1":"untrack","2":"update"}}]},{"name":"waypoint","type":["container",[{"name":"hasUUID","type":"bool"},{"anon":true,"type":["switch",{"compareTo":"hasUUID","fields":{"true":["container",[{"name":"uuid","type":"UUID"}]],"false":["container",[{"name":"id","type":"string"}]]}}]},{"name":"icon","type":["container",[{"name":"style","type":"string"},{"name":"color","type":["option",["container",[{"name":"red","type":"u8"},{"name":"green","type":"u8"},{"name":"blue","type":"u8"}]]]}]]},{"name":"type","type":["mapper",{"type":"varint","mappings":{"0":"empty","1":"position","2":"chunk","3":"azimuth"}}]},{"name":"data","type":["switch",{"compareTo":"type","fields":{"position":["container",[{"name":"x","type":"varint"},{"name":"y","type":"varint"},{"name":"z","type":"varint"}]],"chunk":["container",[{"name":"chunkX","type":"varint"},{"name":"chunkZ","type":"varint"}]],"azimuth":"f32"}}]}]]}]],

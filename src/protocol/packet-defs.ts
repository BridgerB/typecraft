...
export const PACKET_DEFS: Readonly<Record<string, unknown>> = {
	...
	"play.toClient.packet_waypoint": ["container",[{"name":"entityId","type":"varint"},{"name":"operation","type":"varint"},{"name":"hasUUID","type":"bool"},{"name":"uuid","type":"UUID"},{"name":"style","type":"string"},{"name":"hasColor","type":"bool"},{"name":"type","type":"varint"},{"name":"x","type":"varint"},{"name":"y","type":"varint"},{"name":"z","type":"varint"}]],
